...
| 模型 | 定位 | 核心优势 |
|------|------|----------|
| Seed 2.0 Pro | 旗舰模型 | 极致性能与智能天花板，全面对标GPT 5.2 |
| Seed 2.0 Lite | 效率标杆 | 性能、速度与成本的平衡 |
| Seed 2.0 Mini | 轻量先锋 | 高并发低延迟 |
| Seed 2.0 Code | 代码专项 | 深度集成TRAE IDE，专注代码生成与理解 |
...
**关键产品特性：**
- **全面对标GPT 5.2**：Seed 2.0 Pro在综合性能上直接与GPT 5.2竞争，定位为新一代旗舰基座模型
- **小时级视频理解（hour-long video understanding）**：原生支持超长视频输入的理解与推理能力
- **极致性价比**：价格比GPT 5.2便宜10倍，大幅降低企业级AI应用成本
- **TRAE IDE深度集成**：Seed 2.0 Code版本与字节跳动旗下TRAE IDE深度集成，提供原生AI编程体验
