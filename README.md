...
覆盖 **12 个主流模型 / 系列** · 持续更新中

[![Reports](https://img.shields.io/badge/Reports-12-blue?style=flat-square)](.)
...
| 5 | 🇨🇳 | [**GLM**](./GLM-research/) | 智谱 AI | 1 | ChatGLM 系列演进与技术路线 |
| 6 | 🇺🇸 | [**GPT**](./GPT-research/) | OpenAI | 1 | GPT-4 系列能力边界与生态 |
| 7 | 🇨🇳 | [**Hunyuan**](./Hunyuan-research/) | 腾讯 | 1 | 混元大模型多模态能力调研 |
| 8 | 🇨🇳 | [**Kimi**](./Kimi-research/) | 月之暗面 | 1 | 长上下文、联网搜索特色能力 |
...
- 🧠 **AI Agent 生成** — 所有报告由 Claude / DeepSeek 等 Agent 自动调研撰写
